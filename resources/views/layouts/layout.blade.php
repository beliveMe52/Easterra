      ...
      <header>
         ...
         <div class="navigation">
            ...
            <div class="navigation__nav-bar nav-bar">
               ...
               <div class="nav-bar__reviews"><a href="./../404/404.html">Reviews</a></div>
            ...
            <div class="empty"></div>
            <div class="contact-us-btn"><a href="#">CONTACT US</a></div>
         </div>
      </header>
      <div class="media-nav">
         ...
         <a href="./../404/404.html"><div class="nav-bar__reviews">Reviews</div></a>
       ...
       <footer>
          <div class="footer-wrap">
             ...
             <div class="footer__search">
                <input type="text" id='footer-search' placeholder="SEARCH"><button id='footer-search-btn'><img src="./../img/footer-rearch.svg" alt="search-logo"></button>
             </div>
          </div>
