       ...
       <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $quiz->answer }}</td>
            <td>{{ $quiz->author }}</td>
            <td><a href="/question/{{$quiz->id}}/like?login={{$a}}&password={{$l}}"><i class="fa fa-thumbs-up fa-2x"></i></a> | <a href="/question/{{$quiz->id}}/dislike?login={{$l}}&password={{$a}}"><i class="fa fa-thumbs-down fa-2x"></i></a> </i></td>
          </tr>
